const ARCHIVES = [
  ...
  { year: "Feb 2026", title: "Clawshi", description: "Kalshi prediction market data as a drop-in OpenClaw skill. Python stdlib only.", link: "https://github.com/Mootbing/Clawshi", tags: ["Python", "OpenClaw"] },
  { year: "Feb 2026", title: "Angine", description: "Built a from-scratch agent runtime with tool calling, job queue, and worker loop. The proof-of-concept for the Nemo thesis.", link: "", tags: ["Python", "Agents"] },
  { year: "Jan 2026", title: "Pento", description: "Notes app with Skia-powered handwriting because Notability charged too much.", link: "", tags: ["React Native", "Skia"] },
  { year: "Dec 2025", title: "shh.secrets", description: "Encrypted env-var sharing & automated API key rotation. Built for founders sharing secrets with contractors — Browserbase rotation + breach detection.", link: "https://github.com/Mootbing/auto-key-rotator", tags: ["Next", "Supabase", "Browserbase"] },
  ...
  { year: "Sep 2025", title: "Jasma", description: "Shared MCP context layer for coding agents — persistent, searchable memory of bugs and fixes. Built at HackGT 25.", link: "https://github.com/Mootbing/HackGT25-Jazma", tags: ["Next", "MCP", "Supabase", "OpenAI"] },
  { year: "Sep 2025", title: "Cleopatra", description: "First-iteration landing page for the Jasma product, branded as an AI development platform.", link: "https://github.com/Mootbing/Cleopatra-Web", tags: ["Next", "TypeScript"] },
  ...
  { year: "Aug 2025", title: "Amtrak Bot", description: "Tracks Amtrak ticket prices on any route. Selenium-driven headless Chrome with popup handling and screenshot capture per run.", link: "https://github.com/Mootbing/Amtrak-Bot", tags: ["Python", "Selenium"] },
  { year: "Aug 2025", title: "anti-nose picker", description: "Webcam pose detection that yells at you when your hand touches your face. TensorFlow PoseNet running in the browser.", link: "https://anti-nose-picker.vercel.app/", tags: ["React", "TensorFlow", "PoseNet"] },
  ...
  { year: "Jul 2025", title: "LockedIn", description: "Chrome ext that GPT-3.5s your LinkedIn feed to hide every \"I'm humbled to announce\" post.", link: "", tags: ["JS", "Chrome Extension", "GPT"] },
  ...
  { year: "Jan 2025", title: "workout-tracking-app", description: "Expo workout logger, abandoned when I realized I'd rather not work out.", link: "", tags: ["Expo"] },
  ...
  { year: "Aug 2023", title: "archives", description: "Dumping ground for Cocos2d Python games, model railroad business, and old stuff from childhood.", link: "", tags: ["Cocos2d", "Python"] },
  ...
  { year: "Sep 2022", title: "Downloads-Sorter", description: "8th-grade Python that watches your Downloads folder and sorts it as you grab.", link: "", tags: ["Python"] },
  { year: "Jun 2022", title: "Panera-Bot", description: "Ordering bot for Panera sip-club drinks.", link: "", tags: ["Python", "Selenium"] },
  { year: "Mar 2022", title: "The-Ship-Name-Generator-V2", description: "shipnamesfor.us. The V2 of a shipping-name generator.", link: "", tags: ["JS", "Web"] },
  ...
  { year: "Sep 2021", title: "Spanish-Quizlet-Maker", description: "Scrapes SpanishDict and outputs Quizlet-importable decks.", link: "", tags: ["Python", "Selenium"] },
  ...
  { year: "Mar 2021", title: "ship-name-maker", description: "OG ship-name generator.", link: "", tags: ["JS"] },
